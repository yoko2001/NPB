...
echo 2 > $DAMON/kdamonds/0/contexts/0/targets/nr_targets
...
#turn on damon
./bin/mg.B.x > mg.B.txt &
echo "$!" > $DAMON/kdamonds/0/contexts/0/targets/1/pid_target
cat  $DAMON/kdamonds/0/contexts/0/targets/1/pid_target
...
cat /sys/fs/cgroup/yuri/pagerank_150M/memory.peak > memory.peak
